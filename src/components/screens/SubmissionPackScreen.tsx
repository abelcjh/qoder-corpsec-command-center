...
const liveSmokeReceipt = [
  ['Current live smoke check', 'Aug 5 19:35 GMT+8: live Worker home route returned HTTP 200 app HTML and the Agnes bridge returned HTTP 200 JSON with a browser-like fixture request.'],
