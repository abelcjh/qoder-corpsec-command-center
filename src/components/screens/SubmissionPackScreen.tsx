...
const liveSmokeReceipt = [
  ['Current live smoke check', 'Aug 6 14:20 GMT+8: live Worker home route returned HTTP 200 app HTML in 179ms and the Agnes bridge returned HTTP 200 JSON in 6.0s with a browser-like fixture request, plus no-secret/API-key-shape checks passed.'],
...
const finalReadinessReceipt = [
  ['Live URL works', 'Latest smoke passed at Aug 6 14:20 GMT+8: public Worker home route HTTP 200, staff-login app shell returned in 179ms.'],
  ['Agnes bridge works', 'Fixture-safe POST /api/ai-brief returned HTTP 200 JSON in 6.0s and passed secret-name/API-key-shape checks.'],
