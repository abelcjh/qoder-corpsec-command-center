...
| Verification script with 70 assertions | `scripts/verify.mts` |
...
| Evidence | Location |
|----------|----------|
| Aug 5 21:06 GMT+8 remote smoke check returned HTTP 200 app HTML for `/` on the Cloudflare Worker | terminal smoke receipt from Ralph loop; `src/components/screens/SubmissionPackScreen.tsx` |
